...
import com.bishe.lr.entities.ApiRet;
import com.bishe.lr.entities.Sensor;
import com.bishe.lr.service.SensorService;
...
//        List<Sensor> sensors = sensorService.sensorHistoryDate();
    ...
    @GetMapping("/guzhangshangchuan") // 故障上报
    public String guzhangtijiao(@RequestParam("address") String address,
